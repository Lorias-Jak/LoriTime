...
import com.jannik_kuehn.common.module.updater.sources.DevUpdateSource;
import com.jannik_kuehn.common.module.updater.sources.ReleaseUpdateSource;
    ...
    private <T> Pair<Version, String> searchUpdateFor(final Pair<Version, String> latest, final List<T> updateSources,
        ...
        for (final T updateSource : updateSources) {
            try {
                ...
                log.error("Could not fetchversions from source: " + e.getMessage(), e);
            }
        }
